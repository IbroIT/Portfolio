    ...
    return (
        <form onSubmit={handleSubmit} className="space-y-6">
            ...
            <div className="space-y-2" data-aos="fade-up" data-aos-duration="1400">
                <label className="block text-sm font-medium text-white">
                    Фото <span className="text-gray-400">(желательно)</span>
                </label>
            ...
            <div className="p-6 border-b border-white/10" data-aos="fade-down" data-aos-duration="800">
                <div className="flex items-center gap-3">
                    ...
                    <h3 className="text-xl font-semibold text-white">
                        Коментарии <span className="text-indigo-400">({totalComments})</span>
                    </h3>
                </div>
            </div>
                ...
                <div className="space-y-4 h-[328px] overflow-y-auto custom-scrollbar pt-1" data-aos="fade-up" data-aos-delay="200">
                    ...
                    {comments.length === 0 && !pinnedComment ? (
                        <div className="text-center py-8" data-aos="fade-in">
                            ...
                            <p className="text-gray-400">Пока нет комментариев. Начните разговор!</p>
                        </div>
                    ) : (

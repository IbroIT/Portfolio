...
const WORDS = ["Frontend & Backend Student", "Tech Enthusiast"];
const TECH_STACK = ["React", "Javascript", "Python", "Tailwind"];
const SOCIAL_LINKS = [
  { icon: Github, link: "https://github.com/IbroIT" },
  { icon: Linkedin, link: "https://www.linkedin.com/in/ibrohim-abdraimov-668665283/" },
  { icon: Instagram, link: "https://www.instagram.com/_ibroofficial_/?hl=id" }
];
        ...
        <div className="container mx-auto px-[5%] sm:px-6 lg:px-[0%] min-h-screen">
          <div className="flex flex-col lg:flex-row items-center justify-center h-screen md:justify-between gap-0 sm:gap-12 lg:gap-20">
            ...
            <div className="w-full lg:w-1/2 space-y-6 sm:space-y-8 text-left lg:text-left order-1 lg:order-1 lg:mt-0"
              data-aos="fade-right"
              data-aos-delay="200">
              <div className="ml-0 lg:ml-36 sm:mt-32 space-y-4 sm:space-y-6">
                <StatusBadge />
                <MainTitle />
                ...
                <p className="text-base md:text-lg text-gray-400 max-w-xl leading-relaxed font-light"
                  data-aos="fade-up"
                  data-aos-delay="1000">
                  Я проектный менеджер и full-stack разработчик, создаю <br />продуманные и эффективные цифровые решения от идеи до запуска.
                </p>
